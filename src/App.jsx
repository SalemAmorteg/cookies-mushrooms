      ...
      <div style={{ background: "#111", border: `4px solid ${ac}`, padding: 28, width: "100%", maxWidth: 520, maxHeight: "90vh", overflowY: "auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
          <div>
            ...
            <style>{`
        /* Ocultar barra de scroll en las tabs para que se pueda deslizar con el dedo limpiamente */
        .tabs-container::-webkit-scrollbar { display: none; }
        .tabs-container { -ms-overflow-style: none; scrollbar-width: none; }

        @media (max-width: 650px) {
          /* Header: Se apila y se centra */
          ...
          /* Hero Card (Plan Destacado): Cambia de fila a columna */
          ...
          /* Ajuste general de márgenes laterales */
...
{/* HEADER */}
      <div style={{ background: "#FDE047", borderBottom: "4px solid #000", padding: "14px 20px", position: "sticky", top: 0, zIndex: 100 }}>
        {/* Agregamos className "app-header" */}
        <div className="app-header" style={{ maxWidth: 920, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, width: "100%" }}>
          {/* Agregamos className "header-title-box" y "header-title-text" */}
          ...
          {/* Agregamos className "header-counters" */}
          <div className="header-counters" style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <div style={{ 
              background: "#000", color: "#FDE047", padding: "6px 16px", fontFamily: "'Bebas Neue',sans-serif", fontSize: 18, letterSpacing: 1.5, 
              borderRadius: "24px", display: "flex", alignItems: "center", gap: 6, boxShadow: "2px 2px 0 rgba(0,0,0,0.3)", border: "2px solid #000"
            }}>
              <span style={{ fontSize: 14 }}>🍪</span> {citas.length}
            </div>
            <div style={{ 
              background: "#fff", color: "#000", padding: "6px 16px", fontFamily: "'Bebas Neue',sans-serif", fontSize: 18, letterSpacing: 1.5, 
              border: "2px solid #000", borderRadius: "24px", display: "flex", alignItems: "center", gap: 6, boxShadow: "2px 2px 0 rgba(0,0,0,0.3)"
            }}>
      ...
      <div style={{ background: "#0a0a0a", padding: "16px 12px", position: "sticky", top: 65, zIndex: 90, borderBottom: "2px solid #222" }}>
        <div style={{ maxWidth: 650, margin: "0 auto", display: "flex", justifyContent: "center", gap: 10, overflowX: "auto", paddingBottom: 4 }}>
          {/* Aquí agregamos "tabs-container" para que se pueda deslizar en móvil ocultando la barra fea */}
        <div className="tabs-container" style={{ maxWidth: 650, margin: "0 auto", display: "flex", gap: 10, overflowX: "auto", paddingBottom: 4, justifyContent: "center" }}></div>
          {TABS.map(([k, l]) => (
